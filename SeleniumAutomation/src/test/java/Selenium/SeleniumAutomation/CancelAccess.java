...
public class CancelAccess extends BaseClass {
  @Test
  public void cancelaccess() throws InterruptedException 
  {
	//Open application
			...
			if(driver.findElement(By.xpath("//*[@id=\"submit_approve_access\"]/div/button/div[2]")).isDisplayed())
			{
				System.out.println("Test is failed allow access should not display");
			}
